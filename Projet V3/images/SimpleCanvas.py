...
class Canvas(QWidget):
    ...
    def paintEvent(self, event):
        ...
        #Test si l'objectif a été atteint
        if ((self.selected_obj == self.parent.objectif[0] )and ((self.angle + 360) %360 == self.parent.objectif[1])) : #(self.angle + 360) %360  permet de convertir les angles negatif en positif
            self.parent.nextTest()
